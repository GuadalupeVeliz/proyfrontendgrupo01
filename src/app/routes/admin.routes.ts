...
export const adminRoutes: Routes = [
  { path: 'login', loadComponent: () => import('../pages/auth/admin-login/admin-login.component').then((m) => m.AdminLoginComponent) },
  {
    path: '',
    canActivate: [authGuard],
    data: { roles: ['Gerente', 'Recepcionista'] },
    children: [
      { path: '', loadComponent: () => import('../pages/admin/dashboard-panel/dashboard-panel.component').then((m) => m.DashboardPanelComponent) },
