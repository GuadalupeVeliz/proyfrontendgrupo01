...
export const adminAuthRoutes: Routes = [
...

  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () => import('../pages/admin/empleados/empleado-form/empleado-form.component').then(m => m.EmpleadoFormComponent)
      },
      {
...

  {
    ...
    children: [
      ...
      {
        path: 'paquetes',
        loadComponent: () => import('../pages/admin/paquetes/paquetes.component').then(m => m.PaquetesComponent)
      },
      {
        path: 'vacantes',
        loadComponent: () => import('../pages/admin/vacantes/vacantes.component').then(m => m.VacantesComponent)
      },
      {
        path: 'reservas',
        loadComponent: () => import('../pages/admin/reservas/reservas.component').then(m => m.ReservasComponent)
      },
      {
        path: 'reservas/:id',
        loadComponent: () => import('../pages/admin/reservas/reservas.component').then(m => m.ReservasComponent)
      ...
      {
        path: 'clientes/nuevo',
        loadComponent: () => import('../pages/admin/clientes/cliente-form/cliente-form.component').then(m => m.ClienteFormComponent)
      },
      {
